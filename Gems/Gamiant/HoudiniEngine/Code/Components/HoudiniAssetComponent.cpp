...
{    
    void HoudiniAssetComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (AZ::SerializeContext* serialize = azrtti_cast<AZ::SerializeContext*>(context))
        {
            serialize->Class<HoudiniAssetComponent, AzToolsFramework::Components::EditorComponentBase>()
                ...
                ->Field("TempCookFolder", &HoudiniAssetComponent::m_tempCookFolder)
                ;
            ...
            if (AZ::EditContext* ec = serialize->GetEditContext())
            {
                ec->Class<HoudiniAssetComponent>("HoudiniDigitalAsset", "Houdini Digital Asset")
                    ...
                    ->Attribute(AZ::Edit::Attributes::Icon, ":/houdini/houdini_icon.svg")
                    ->Attribute(AZ::Edit::Attributes::ViewportIcon, ":/houdini/houdini_icon.svg")
                    ...
                    ->ClassElement(AZ::Edit::ClassElements::Group, "Generate")
                    ->UIElement(AZ::Edit::UIHandlers::Button, "Recook")
                        ->Attribute(AZ::Edit::Attributes::ButtonText, "Recook")
                    ->Attribute(AZ::Edit::Attributes::NameLabelOverride, "")
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &HoudiniAssetComponent::OnRecook)
                    ->UIElement(AZ::Edit::UIHandlers::Button, "Rebuild")
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &HoudiniAssetComponent::OnRebuild)
                    ->Attribute(AZ::Edit::Attributes::ButtonText, "Rebuild")
                    ->Attribute(AZ::Edit::Attributes::NameLabelOverride, "")
                    ->UIElement(AZ::Edit::UIHandlers::Button, "Reset Parameters")
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &HoudiniAssetComponent::OnResetParameters)
                    ->Attribute(AZ::Edit::Attributes::ButtonText, "Reset Parameters")
                    ->Attribute(AZ::Edit::Attributes::NameLabelOverride, "")
                    ->DataElement(AZ::Edit::UIHandlers::Default, &HoudiniAssetComponent::m_tempCookFolder, "Temporary Cook Folder", "Folder to store temporary files generated by Houdini Assets when they cook. Leave blank to use default settings.")
                    
                    


                    ->ClassElement(AZ::Edit::ClassElements::Group, "Bake")
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                     ->DataElement(0, &HoudiniAssetComponent::m_fbxConfig, "Bake Settings", "")
                        ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly)

                    ->ClassElement(AZ::Edit::ClassElements::Group, "Asset Settings")
                    ->ClassElement(AZ::Edit::ClassElements::Group, "Cook Triggers")
                    ->ClassElement(AZ::Edit::ClassElements::Group, "Outputs")
    ...
    void HoudiniAssetComponent::OnRecook()
    {

    }

    void HoudiniAssetComponent::OnRebuild()
    {

    }

    void HoudiniAssetComponent::OnResetParameters()
    {
